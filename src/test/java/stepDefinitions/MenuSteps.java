...
public class MenuSteps {
    ...
    public void customer_membuka_url_qr_dari_background() {
        ...
        // ==========================================
        // TRICK: HAPUS SESSION ADMIN SEBELUM CUSTOMER MASUK
        // ==========================================

        // 1. Hapus semua cookies (biasanya menyimpan token login)
        driver.manage().deleteAllCookies();

        // 2. Hapus Local Storage & Session Storage (sangat penting jika web-mu menggunakan React/Vue/Next.js)
        JavascriptExecutor js = (JavascriptExecutor) driver;
        try {
            js.executeScript("window.localStorage.clear();");
            js.executeScript("window.sessionStorage.clear();");
        } catch (Exception e) {
            System.out.println("Local storage belum tersedia/gagal dibersihkan: " + e.getMessage());
        }
        // ==========================================
