...
public class Locators {
    ...
    public static final By ADMIN_MENU_NAME_INPUT= By.cssSelector("input[name='name'], input[id='name']");
    public static final By ADMIN_MENU_PRICE_INPUT= By.cssSelector("input[name='price'], input[type='number']");
    public static final By ADMIN_MENU_SAVE_BTN  = By.cssSelector("button[type='submit']");
